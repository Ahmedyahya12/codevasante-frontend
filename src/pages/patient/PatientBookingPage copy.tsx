...
export default function PatientBookingPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      await axiosInstance.post('/appointments/create/', payload);
      ...
      <main className="mx-auto max-w-7xl px-4 pb-16 sm:px-6 lg:px-8">
        <div className="grid gap-7 lg:grid-cols-[1fr_520px]">
          ...
          <aside className="space-y-6">
            ...
            <div className="rounded-[24px] bg-red-500 p-7 text-right text-white shadow-soft">
              <h3 className="text-2xl font-extrabold">حالة طارئة؟</h3>
              <p className="mt-3 text-sm font-bold text-white/90">اتصل مباشرة برقم الطوارئ:</p>
              <p className="mt-4 text-2xl font-extrabold" dir="ltr">
                +222 44 00 00 00
              </p>
            </div>
          </aside>
